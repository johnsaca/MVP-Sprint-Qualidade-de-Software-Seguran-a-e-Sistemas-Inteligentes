...
# Parâmetros    
url_dados = "database/heart_attack_prediction_dataset adapted v2.csv"
colunas = ['age','sex','chol','blup','bllow','rate','dia','fam','smok','obes','alco',
'exer','diet','prev','medi','stress','seden','income','bmi','trigly','activity','sleep',]
...
def test_modelo_lr():  
    ...
    lr_path = 'ml_model/modelo_treinado.pkl'
